...
<section class="full-width-container heightSync">
  ...
  <div class="overlayContent fullOverlay heightReference">
    ...
    <div class="col-sm-10 col-lg-8 aboutList">
        <div class="col-sm-6 floatLeft">
            <div class="title">As part of the standard package Halodome Ltd will also supply:</div>
            <ul>
            	<li>Thermal modelling of your preferred internal layout, and the required orientation and glazing design to achieve Passivhaus standard.</li>
                <li>Full triple glazing package comprising - 2 doors with side lights and 4 opening windows for the ground floor and 9 opening roof light windows.</li>
                <li>A minimum specification for the foundation slab & services, local engineers will be required to check and adjust the design to suit local site conditions.</li>
                <li>Onsite technical support during assembly of the outer shell, based on 1 person for 5 days.</li>
            </ul>
            
            <div class="title">As an optional extra and not included in our standard price we can provide:</div>
            <ul>
            	<li>Delivery in containers to the nearest port or your site.</li>
                <li>Our standard design of internal mezzanine and spiral staircase.</li>
                <li>Additional windows or doors, the will affect passivhaus compliance in most locations.</li>
                <li>Mechanical ventilation and heat recovery units to suit the local climate.</li>
                <li>Ongoing support during full Passivhaus certification.</li>
                <li>Customer supplied interior linings and exterior roof claddings.</li>
                <li>Additional on-site technical support during assembly.</li>
                <li>Furnishings selected from the Halo range.</li>
            </ul>
        </div>
        <div class="col-sm-6 floatRight">
        	<div class="title">The Halodome is a factory produced building designed to be assembled and finished by the customer. Under this arrangement the customer is responsible for providing the following:</div>
			<ul>
            	<li>All and any reuqired architectural services and advice.</li>
                <li>Planning consent and all local regulatory compliance relating to the building including fire and safety etc.</li>
            	<li>All design related to the internal layout, taking into account Passivhaus specifications, if required.</li>
                <li>All design and installation of the foundations, floor slab and all services. Halodome will provide specifications for the minimum standard of required foundation. </li>
                <li>All internal ground floor finishes, wall partitions, kitchens, bathrooms, white goods etc.</li>
                <li>All labour and handing equipment for unloading of the containers and assembly of the building including taping of air tight internal membranes and installation of the timber linings.</li>
            	<li>All electrical & plumbing services.</li>
            	<li>Fire retardant treatment of the internal linings or mezzanine timbers to meet local reuqirements.</li>
            	<li>Site access.</li>
            	<li>All site insurance etc.</li>
            </ul>
        </div>
      </div>
  </div>
