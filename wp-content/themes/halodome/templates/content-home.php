...
<section style="background-image: url(<?=get_stylesheet_directory_uri()?>/assets/img/main-img-2.jpg);" class="cd-fixed-bg slide cd-bg-1 ss-active"> 
  <div class="image-caption">
...
<section class="full-width-image" id="halodome-floorplan" style="text-align:center;">
	<h2>Halodome Floorplan</h2>
	<img class="img-responsive" src="<?=get_stylesheet_directory_uri()?>/assets/img/floor-plan.jpg" alt="" style="margin:0 auto;"/>
</section>
<section style="background-image: url(<?=get_stylesheet_directory_uri()?>/assets/img/main-img-6.jpg);" class="cd-fixed-bg slide cd-bg-1 ss-active">
</section>
