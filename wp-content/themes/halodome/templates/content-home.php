<section class="full-width-container">
  <img id="mainImg1" class="bg" src="<?=get_stylesheet_directory_uri()?>/assets/img/main-img-1.jpg" />
...
<section class="full-width-container">
  <img id="mainImg2" class="bg" src="<?=get_stylesheet_directory_uri()?>/assets/img/main-img-2.jpg" />
  	<!-- data-bttrlazyloading-animation="fadeIn" 
  ...
  <div class="overlayContent">
	  <div class="image-caption image-caption-darker">
...
<section class="full-width-container half-height">
  <img id="mainImg4" class="bg" src="<?=get_stylesheet_directory_uri()?>/assets/img/main-img-4.jpg" />
    <!-- data-bttrlazyloading-animation="fadeIn"
...
<section class="full-width-container half-height">
  <img id="mainImg3" class="bg" src="<?=get_stylesheet_directory_uri()?>/assets/img/main-img-3.jpg" />
  	<!-- data-bttrlazyloading-animation="fadeIn"
...
<section class="full-width-container half-height">
  <img id="mainImg5" class="bg" src="<?=get_stylesheet_directory_uri()?>/assets/img/main-img-5.jpg" />
  	<!-- data-bttrlazyloading-animation="fadeIn"
...
<section class="full-width-container">
  <img id="mainImg6" class="bg" src="<?=get_stylesheet_directory_uri()?>/assets/img/main-img-6.jpg" />
  	<!-- data-bttrlazyloading-animation="fadeIn"
